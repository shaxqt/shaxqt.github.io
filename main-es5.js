    ...
    function wwYV(module, __webpack_exports__, __webpack_require__) {
      ...
      var EvidenceStateComponent = /*#__PURE__*/function () {
        function EvidenceStateComponent() {
          ...
          this.options = [{
            name: _game_data_proof_state__WEBPACK_IMPORTED_MODULE_4__["ProofState"].NEVER,
            value: 'NEVER'
          }, {
            name: _game_data_proof_state__WEBPACK_IMPORTED_MODULE_4__["ProofState"].DONT_KNOW,
            value: 'DONT_KNOW'
          }, {
            name: _game_data_proof_state__WEBPACK_IMPORTED_MODULE_4__["ProofState"].PROOFED,
            value: 'PROOFED'
          }];
        }
        ...
        _createClass(EvidenceStateComponent, [{
          key: "updateEvidence",
          value: function updateEvidence(event) {
            this.state = Object.assign(Object.assign({}, this.state), {
              state: _game_data_proof_state__WEBPACK_IMPORTED_MODULE_4__["ProofState"][event.target.value]
            });
